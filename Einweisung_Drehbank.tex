...
\todo{Bei uns vorrätige Materialien markieren: welches Alu? welcher Stahl? POM = Kunststoff?}
\end{table}
...
\todo{Drehbank offen stehen lassen oder schließen? Bisher war der Konsens offen damit es nicht so krass rostet, aber bei zu kriegen die KSS-Bewohner weniger Futter?}
