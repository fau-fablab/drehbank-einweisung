...
\begin{itemize}
 ...
 \item  \textbf{Für die Benutzung des Handbetriebs ist eine zusätzliche schriftliche Erlaubnis nötig!} Es gelten dabei weitere Vorschriften, siehe Kapitel \ref{Handdrehen}. \todo{Bezug auf nicht existierendes Label}
\end{itemize}
...
\end{itemize}
 ...
 \item Metallspäne können sehr scharf und heiß sein (besonders bei Stahl/Edelstahl). Späne dürfen nicht von Hand beseitigt werden, Spänehaken/Zange, Pinsel/Wischer oder Staubsauger verwenden. % per Hand nicht zulässig nach BGI 5003 2.5.
